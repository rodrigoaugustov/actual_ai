...
export const schema = {
  ...
  ai_runs: {
    id: f('id'),
    agent: f('string', { required: true }),
    tier: f('string', { required: true }),
    provider: f('string', { required: true }),
    model: f('string', { required: true }),
    input_tokens: f('integer'),
    output_tokens: f('integer'),
    cache_read_tokens: f('integer'),
    cache_write_tokens: f('integer'),
    cost_usd: f('float'),
    duration_ms: f('integer'),
    status: f('string', { required: true }),
    error: f('string'),
    created_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_rule_meta: {
    id: f('id'),
    rule_id: f('id', { ref: 'rules' }),
    payee_name: f('string', { required: true }),
    op: f('string', { required: true }),
  ...
  ai_suggestions: {
    ...
    confidence: f('float', { required: true }),
    rationale: f('string', { required: true }),
    status: f('string', { required: true }),
    run_id: f('id'),
    created_at: f('date', { required: true }),
  ...
  ai_feedback: {
    ...
    payee_name: f('string'),
    normalized_payee: f('string', { required: true }),
    amount: f('integer'),
    suggested_category_id: f('id', { ref: 'categories' }),
    final_category_id: f('id', { ref: 'categories' }),
    source: f('string', { required: true }),
    suggestion_id: f('id', { ref: 'ai_suggestions' }),
    run_id: f('id'),
    created_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_category_profiles: {
    id: f('id'),
    category_id: f('id', { ref: 'categories', required: true }),
    description: f('string', { required: true }),
    updated_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_merchant_enrichments: {
    id: f('id'),
    normalized_query: f('string', { required: true }),
    locale: f('string', { required: true }),
    summary: f('string', { required: true }),
    sources_json: f('string', { required: true }),
    expires_at: f('date', { required: true }),
    created_at: f('date', { required: true }),
    updated_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_rule_hits: {
    id: f('id'),
    rule_meta_id: f('id', { ref: 'ai_rule_meta', required: true }),
    rule_id: f('id', { ref: 'rules', required: true }),
    transaction_id: f('id', { ref: 'transactions', required: true }),
    category_id: f('id', { ref: 'categories', required: true }),
    status: f('string', { required: true }),
    rationale: f('string'),
  ...
  ai_messages: {
    ...
    conversation_id: f('id', {
      ref: 'ai_conversations',
      required: true,
    }),
    role: f('string', { required: true }),
    content: f('string', { required: true }),
    parts_json: f('string'),
    run_id: f('id', { ref: 'ai_runs' }),
    created_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_memory_facts: {
    id: f('id'),
    subject: f('string', { required: true }),
    kind: f('string', { required: true }),
    value_json: f('string', { required: true }),
    original_text: f('string'),
    source: f('string', { required: true }),
    confidence: f('float', { required: true }),
    status: f('string', { required: true }),
    sensitivity: f('string', { required: true }),
    source_message_id: f('id', { ref: 'ai_messages' }),
    source_document_id: f('id', { ref: 'ai_documents' }),
    supersedes_id: f('id', { ref: 'ai_memory_facts' }),
    valid_from: f('date'),
    valid_to: f('date'),
    last_confirmed_at: f('date'),
    created_at: f('date', { required: true }),
    updated_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ai_goals: {
    ...
    title: f('string', { required: true }),
    description: f('string', { required: true }),
    target_amount: f('integer'),
    target_date: f('date'),
    priority: f('integer', { required: true }),
    flexibility: f('string', { required: true }),
    status: f('string', { required: true }),
    progress_note: f('string'),
    next_review_at: f('date'),
    created_at: f('date', { required: true }),
    updated_at: f('date', { required: true }),
    tombstone: f('boolean'),
  },
  ...
  ai_advice_records: {
    id: f('id'),
    conversation_id: f('id', { ref: 'ai_conversations' }),
    title: f('string', { required: true }),
    recommendation: f('string', { required: true }),
    assumptions_json: f('string'),
    evidence_json: f('string'),
    alternatives_json: f('string'),
    risks_json: f('string'),
    status: f('string', { required: true }),
    follow_up_at: f('date'),
    created_at: f('date', { required: true }),
